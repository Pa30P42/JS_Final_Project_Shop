...
const addToCart = product => {
  const existProduct = userData.cart.cartItems.find(
  ...
  if (existProduct) {
    ...
    userData.cart.cartItems = [newProduct, ...userData.cart.cartItems];
  }
};
...
const removeCartItem = e => {
  ...
  document.querySelector('.cart').innerHTML = createCartListMarkup(
    userData.cart,
    userData.cart.totalAmount,
  );
...
const showCart = () => {
  ...
  modalModule(createTemplateMarkup, listeners);
